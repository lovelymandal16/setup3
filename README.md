...
## Environments
- Preview: https://main--setup3--lovelymandal16.hlx.page/
- Live: https://main--setup3--lovelymandal16.hlx.live/
...
1. Open the `setup3` directory in your favorite IDE and start coding :)
